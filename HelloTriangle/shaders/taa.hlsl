...
// Performs 3x3 neighborhood AABB clamping and inter-frame blending.
// ============================================================
...
cbuffer TAACB : register(b0)
{
    ...
    float  blendFactor; // history blend factor (0.9 = 90% history)
    float  pad;
};
...
// Clamp history sample to neighborhood AABB (prevents ghosting artifacts)
...
float4 TAAPS(VSOut i) : SV_Target
{
    ...
    // Compute the 3×3 neighborhood AABB
    ...
    // Clamp history to AABB to prevent ghosting
