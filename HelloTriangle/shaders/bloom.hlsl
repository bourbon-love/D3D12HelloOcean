...
// Provides a brightness extraction pass and a separable Gaussian blur pass (H/V).
// ============================================================
...
cbuffer BloomCB : register(b0)
{
    ...
    float strength;   // multiplier coefficient at composite time
...
// Extract pixels brighter than the threshold
...
float4 BlurPS(VSOut i) : SV_Target
{
    ...
    // sigma ≈ 1.5, weights normalized to sum to 1
...
// Additively blend bloom into the scene (SrcBlend=ONE, DestBlend=ONE)
